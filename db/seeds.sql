...
INSERT INTO roles (title, salary, department_id) VALUES ('CFO', 100000, 1);
INSERT INTO roles (title, salary, department_id) VALUES ('Customer Support Manager', 160000, 4);
INSERT INTO roles (title, salary, department_id) VALUES ('Customer Liaison', 70000, 4);

-- Employees
INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ('Jim', 'Jones',1);
INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ('Lucy', 'Loo',2);
INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ('Mary', 'Lamb',3 ,2);
INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ('Anna', 'Banana',4);
INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ('Frank', 'Beans',5 ,4);
...
INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ('Abraham', 'Lincoln',8);
INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ('Liz', 'Lemon',9);
